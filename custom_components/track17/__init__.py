...
from .const import DEFAULT_SCAN_INTERVAL_MINUTES, DOMAIN, SERVICE_DELETE_DELIVERED_PACKAGES
...
def _async_register_services(hass: HomeAssistant) -> None:
    """
    Register the delete_delivered_packages service, if it is not already registered.

    param hass: The Home Assistant instance.

    :return: None
    """
    if hass.services.has_service(DOMAIN, SERVICE_DELETE_DELIVERED_PACKAGES):
        return
